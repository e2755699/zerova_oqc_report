# Zerova OQC Report System v2.2.0
...
The application uses ssets/config.json from the data folder. If needed, you can also place a config.json file in the same directory as the executable.
